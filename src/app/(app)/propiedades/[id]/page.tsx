  ...
  return (
    <div>
      <p className="mb-3 rounded-lg bg-slate-100 px-3 py-2 text-xs text-slate-500">
        Este inventario es independiente del de la bodega — se lleva por
        separado en cada loft.{" "}
        {warehouseId
          ? `Debajo de cada insumo se muestra cuánto hay en ${warehouse?.name} como referencia.`
          : "Esta propiedad no tiene bodega asignada."}
      </p>
